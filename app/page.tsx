...
export default function Home() {
  ...
  return (
    <main className="relative overflow-hidden bg-night text-white font-body">
      ...
      <section className="relative flex min-h-screen items-center justify-center px-6 py-16">
        ...
        <div className="relative z-20 mx-auto max-w-6xl text-center">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.45 }} className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <a href="#musica" className="rounded-full bg-white px-8 py-3 text-sm font-bold uppercase tracking-[0.2em] text-black transition hover:scale-105">Escuchar ahora</a>
            <a href="#videos" className="rounded-full border border-white/50 bg-white/10 px-8 py-3 text-sm font-bold uppercase tracking-[0.2em] text-white backdrop-blur transition hover:scale-105 hover:border-neonBlue/80 hover:shadow-cyan">Ver videos</a>
          </motion.div>
      ...
      <section id="musica" className="relative px-6 py-20">
        <div className="mx-auto max-w-6xl">
          <h3 className="font-display text-4xl font-extrabold md:text-5xl">Musica en movimiento</h3>
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-6xl">
          <h3 className="font-display text-4xl font-extrabold md:text-5xl">Galeria Visual</h3>
      ...
      <section id="videos" className="px-6 py-20">
        <div className="mx-auto max-w-6xl">
          <h3 className="font-display text-4xl font-extrabold md:text-5xl">Visualizers / Reels</h3>
      ...
      <section className="px-6 pb-24 pt-8 text-center">
        <motion.h4 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} className="font-display text-5xl font-black md:text-7xl">
          Sigue el pulso
        </motion.h4>
